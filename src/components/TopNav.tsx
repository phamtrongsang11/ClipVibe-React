...
import logo from '../assets/images/clip_vibe.png';
import {
	AiOutlineSearch,
	AiOutlineFileSearch,
	AiOutlineUpload,
	...
	return (
		...
		>
			...
			>
				...
				<div className="hidden md:flex items-center bg-[#F1F1F1] p-1 rounded-full max-w-[450px] w-full">
					<input
						type="text"
					...
					<div className="flex items-center justify-center gap-2">
						...
						<div className="relative">
							...
							{showMenu && (
								<div
									id="PopupMenu"
									className="absolute bg-white rounded-lg py-1.5 w-[150px] shadow-xl border top-[43px] -right-2"
								>
									<Link
									...
									{user.id && (
										<div
											...
											className="flex gap-2 justify-start px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 cursor-pointer"
										>
