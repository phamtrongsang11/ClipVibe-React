	...
	return (
		...
		>
			<div className="lg:w-[calc(100%-540px)] h-full relative">
				<Link
					to="/"
					className="absolute z-20 m-5 rounded-full hover:bg-gray-800 bg-gray-700 p-3"
				>
					{' '}
					<ImCross color="#FFFFFF" size="25" />
				</Link>
				<button
			...
			<div
				className="lg:max-w-[550px] flex flex-col gap-3 relative w-full h-full bg-white"
				id="InfoSection"
			>
				<div className="py-5" />
				<div className="flex items-center justify-between px-8">
					<div className="flex items-center">
						...
						<div className="flex flex-col ml-3 pt-0.5">
							...
							<div className="justify-center items-center text-[14px] mt-1 font-light ">
								{/* {dataPost?.getPostById?.user.fullname} */}
				...
				<div className="flex gap-2 px-8 mt-4 text-sm font-bold">
					<BsMusicNoteBeamed size="17" />
					Original sound - Summer Gone
				</div>
				<div className="flex items-center px-8 mt-4">
					<div className="pb-4 text-center flex items-center">
						...
						>
							<AiFillHeart size="25" color={isLiked ? '#F02C56' : 'black'} />
						</button>
						<span className="text-xs pl-2 pr-4 text-[#F02C56] font-semibold">
							{dataPost?.getPostById?.likes.length}
						</span>
					</div>
					<div className="pb-4 text-center flex items-center">
						<div className="rounded-full bg-gray-200 p-2 cursor-pointer">
							<BsFillChatDotsFill size="25" color="#2c7af0" />
						</div>
						<span className="text-xs pl-2 pr-4 text-[#2c7af0] font-semibold">
					...
					<button
						...
						className={[
							comment
								...
								: 'text-gray-400',
							'font-bold text-md ml-2 px-2 py-2 rounded-sm ',
						].join(' ')}
					>
						Post
					</button>
